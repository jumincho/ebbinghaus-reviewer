...
// View-switching for MainWindow's side nav. Each nav button binds to one of
// the Show*Command properties; CurrentView is the ContentControl's Content
// target in MainWindow.xaml.
...
namespace Review_Reminder.MVVM.ViewModel
{
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        {
            // The scheduler is wired into App.xaml.cs's OnStartup; we just pull
            // the live instance from the App singleton. (Pre-DI 2021 vibes.)
