...
// The textbook Ebbinghaus spaced-repetition offsets. Four slots — matching
// the four TextBlocks (first/snd/thd/forth) found in TodolistReminder.g.cs.
// The original could plausibly have used a different exact set of offsets;
// these are a reasonable choice for a classroom-style Ebbinghaus implementation.
...
namespace Review_Reminder.MVVM.Model
{
    ...
    /// All time arithmetic in the rest of the app should pass through here so
    /// that "change the curve" is a one-file edit.
    /// </summary>
    public static class EbbinghausCurve
    {
        /// <summary>
        /// The four textbook offsets at which the original app surfaces a
        /// reminder. These match the four TextBlocks in TodolistReminder.
        ///
